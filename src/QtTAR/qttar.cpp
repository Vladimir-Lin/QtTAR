...
struct tar_stat_info                                                         {
  ...
  bool              had_trailing_slash                                       ;  /* true if the current archive entry had a trailing slash before it was normalized. */
...
bool QtTAR::Extract ( QByteArray & data , void * hiddenFileInfo )            {
  ...
  hfi -> Time     = QDateTime::fromSecsSinceEpoch ( mtime )                  ;
