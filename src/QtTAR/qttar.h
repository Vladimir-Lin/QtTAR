...
//////////////////////////////////////////////////////////////////////////////
#define QT_TAR_LIB 1
#define QT_TAR_VERSION 202107111826
//////////////////////////////////////////////////////////////////////////////
...
class Q_TAR_EXPORT QtTAR                                                     {
  ...
  public                                                                     :
    ...
    //////////////////////////////////////////////////////////////////////////
    virtual bool   Extract      ( QByteArray & block                         ,
                                  void       * hiddenFileInfo              ) ; // block => File
    virtual bool   Bale         ( void       * hiddenFileInfo                ,
...
class Q_TAR_EXPORT QtTarBall : public QtTAR                                  {
  ...
  public                                                                     :
    ...
    //////////////////////////////////////////////////////////////////////////
    virtual bool   TarBall          ( QIODevice & IO                         ,
                                      QDir        root                       ,
                                      QDir        source                     ,
                                      bool        recursive = true         ) ;
    virtual bool   TarBall          ( QString filename                       ,
                                      QDir    root                           ,
                                      QDir    source                         ,
                                      bool    recursive = true             ) ;
    //////////////////////////////////////////////////////////////////////////
  protected                                                                  :
    ...
    //////////////////////////////////////////////////////////////////////////
    virtual bool   ListFile         ( QDir        root                       ,
                                      QIODevice & IO                         ,
                                      void      * hiddenFileInfo           ) ;
    virtual bool   Extract          ( QDir        root                       ,
                                      QIODevice & IO                         ,
                                      void      * hiddenFileInfo           ) ;
    //////////////////////////////////////////////////////////////////////////
    virtual bool   Read             ( QIODevice  & IO                        ,
                                      QByteArray & data                      ,
                                      qint64       size                    ) ;
    ...
    //////////////////////////////////////////////////////////////////////////
    virtual bool   ExtractFile      ( QDir        root                       ,
                                      QIODevice & IO                         ,
                                      void      * hiddenFileInfo           ) ;
    virtual bool   ExtractDir       ( QDir        root                       ,
                                      QIODevice & IO                         ,
                                      void      * hiddenFileInfo           ) ;
    virtual bool   ExtractLink      ( QDir        root                       ,
                                      QIODevice & IO                         ,
                                      void      * hiddenFileInfo           ) ;
    virtual bool   ExtractDEVs      ( QDir        root                       ,
                                      QIODevice & IO                         ,
                                      void      * hiddenFileInfo           ) ;
    virtual bool   ExtractNext      ( QDir        root                       ,
                                      QIODevice & IO                         ,
                                      void      * hiddenFileInfo           ) ;
    virtual bool   ExtractEXT       ( QDir        root                       ,
                                      QIODevice & IO                         ,
                                      void      * hiddenFileInfo           ) ;
    virtual bool   setFileTime      ( QDir        root                       ,
                                      QIODevice & IO                         ,
                                      void      * hiddenFileInfo           ) ;
    virtual bool   setFileMode      ( QDir        root                       ,
                                      QIODevice & IO                         ,
                                      void      * hiddenFileInfo           ) ;
    //////////////////////////////////////////////////////////////////////////
    virtual QFileInfoList Listing   ( QDir & root , QDir source            ) ;
    virtual bool   WriteTAR         ( QIODevice & IO                         ,
                                      QDir      & root                       ,
                                      QFileInfo & file                     ) ;
    virtual bool   ToHiddenFileInfo ( QDir      & root                       ,
                                      QFileInfo & file                       ,
                                      void      * hiddenFileInfo           ) ;
    //////////////////////////////////////////////////////////////////////////
